...
folder are mapped to the application's root namespace, 'MaiJiangDou'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "MaiJiangDou"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'MaiJiangDou' in the same way
as `"MaiJiangDou/sass/src"`.
